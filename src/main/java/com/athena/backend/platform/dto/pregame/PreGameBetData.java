...
public final class PreGameBetData {
	...
	public final String toString() {
		return "PreGameBetData [game_id=" + game_id + ", home_team_id=" + home_team_id + ", home_team_name="
				+ home_team_name + ", away_team_id=" + away_team_id + ", away_team_name=" + away_team_name
				+ ", team_home_risk=" + team_home_risk + ", team_home_win=" + team_home_win + ", team_away_risk="
				+ team_away_risk + ", team_away_win=" + team_away_win + ", score_threshold=" + score_threshold
				+ ", score_less_risk=" + score_less_risk + ", score_more_risk=" + score_more_risk + ", score_less_win="
				+ score_less_win + ", score_more_win=" + score_more_win + ", players=" + players + "]";
	}
}
