...
public final class PreGameBetRequest {
	...
	public final int hashCode() {
		...
		result = prime * result + ((nonOfThePlayers == null) ? 0 : nonOfThePlayers.hashCode());
	...
	public final boolean equals(final Object obj) {
		...
		if (gameId == null) {
			...
			return false;
		if (nonOfThePlayers == null) {
			if (other.nonOfThePlayers != null)
				return false;
		} else if (!nonOfThePlayers.equals(other.nonOfThePlayers))
			return false;
		if (playerId == null) {
	...
	public final String toString() {
		return "PreGameBetRequest [type=" + type + ", gameId=" + gameId + ", teamId=" + teamId + ", playerId="
				+ playerId + ", nonOfThePlayers=" + nonOfThePlayers + ", scoreBet=" + scoreBet + ", riskAmount="
				+ riskAmount + ", winAmount=" + winAmount + ", winningThreshold=" + winningThreshold + "]";
	}
}
