...
public class Emitter {
    ...
    public void removeAllCallbacks() {
        for (@SuppressWarnings("rawtypes") Map.Entry e : singlecallbacks.entrySet()) {
            singlecallbacks.remove(e.getKey().toString());
        }
        for (@SuppressWarnings("rawtypes") Map.Entry e : singleackcallbacks.entrySet()) {
            singleackcallbacks.remove(e.getKey().toString());
        }
        for (@SuppressWarnings("rawtypes") Map.Entry e : publishcallbacks.entrySet()) {
